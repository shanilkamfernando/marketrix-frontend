...
//import MLiveTabs from "../../MLiveTabs/MLiveTabs";
// import incomingCardData from "./incomingCardData.json";
// import missedCardData from "./missedCardData.json";
...
import {
  ...
  getIncomingOngoingInquiriesCall,
} from "./apiCalls";
...
function IncomingCard({
  ...
  const updateIncomingTable = () => {
    // Execute the function when triggered
    getIncomingInquiries();
    dispatch(updateIncoming(false));
  };
  ...
  const deleteInquiry = async () => {
    deleteInquiryCallParent(); // delete the inquiry from the database
  };
                    ...
                    <div>
                      <div className="">
                        <InquiryGridCard
                          ...
                          handleViewInquiry={() =>
                            handleViewInquiryCallParent(inquiry)
                          }
                          connectButtonHandle={() =>
                            inquiryButtonHandle(inquiry)
                          }
                  ...
                  return (
                    <tr
                      className={`border-b border-gray-300 text-[14px]  font-normal hover:bg-[#D0D5DD] hover:ease-in hover:duration-200 ${
                        ...
                        "bg-[#8256C7] !font-semibold text-[#F9F5FF]"
                      } cursor-default`}
                      key={index}
